...
window.addEventListener('tizenhwkey', function(e) {
    if (e.keyName === "back") {
    	...
    	else if(screen === "nc_searchCars"){
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "nc_brandDetails"){      //   nc_brandDetails
    		window.location.href="#/event/nc-search-cars";
    		screen = "nc_searchCars";
    	}else if(screen === "nc_modelDetails"){      //   nc_modelDetails
     		window.location.href="#/event/nc-brand-details/"+brandd;
    		screen = "nc_brandDetails";
    	}else if(screen === "nc_getOnRoadPriceFormCtrl"){      //   nc_getOnRoadPriceFormCtrl
    		window.location.href="#/event/nc-model-details/"+brandModel;
    		screen ="nc_modelDetails";
    	}else if(screen === "nc_getOnRoadPriceDetailCtrl"){      //   nc_getOnRoadPriceDetailCtrl
    		//alert(roadPriceForm);
    		//window.location.href="#/event/nc-get-on-road-price-form"+roadPriceForm;
    		//screen ="nc_getOnRoadPriceFormCtrl";
    		window.location.href="#/event/nc-model-details/"+brandModel;
    		screen ="nc_modelDetails";
    	} 
    	...
    	else if(screen === "usedCarHomeCtrl"){       //  usedCarHomeCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "usedCarDetailCtl"){      //   usedCarDetailCtl
    		if(tt === "trusted"){
    			window.location.href="#/event/home";
        		screen = "home";
        		tt="";
    		}else{
    		window.location.href="#/event/used-car-home";
    		screen = "usedCarHomeCtrl";
    		}
    	} else if(screen === "usedsingleCarDetailCtl"){            //   usedsingleCarDetailCtl
    		window.location.href="#/event/used-car-detail/";
    		screen ="usedCarDetailCtl";
    	}
    	
    	
    	// Review User
    	else if(screen === "reviewUserAndRoadTestCtrl"){      //   reviewUserAndRoadTestCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "userReviewCtrl"){      //   #/event/user-review
    		window.location.href="#/event/review-user-and-road-test";
    		screen = "";
    	}else if(screen === "userReviewDetailCtrl"){      //   userReviewDetailCtrl
    		window.location.href="#/event/user-review";
    		screen = "";
    	} 
    	
    	
    	else if(screen === "nc_upcomingCars"){      // nc_upcomingCars
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "nc_latestCars"){         //  nc_latestCars
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "nc_popularCars"){         // nc_popularCars
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "nc_offersAndDiscounts"){      //  nc_offersAndDiscounts
    		window.location.href="#/event/home"; 
    		screen = "home";
    	}else if(screen === "nc_carVideos"){            //   nc_carVideos
    		window.location.href="#/event/home";
    		screen = "home";
    	} else if(screen === "usedCarValuationCtrl"){   //  usedCarValuationCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "compareCarsCtrl"){      //   compareCarsCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "sellACarCtrl"){      //   sellACarCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "autoNewsCtrl"){      //   autoNewsCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "carInsuranceCtrl"){      //   carInsuranceCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "carDealersCtrl"){      //   carDealersCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	}else if(screen === "carLoanCtrl"){      //   carLoanCtrl
    		window.location.href="#/event/home";
    		screen = "home";
    	} 
...
//    if (e.keyName == "back") {
//    	
//    	if(eventmenu.home == true){
//    		window.tizen.application.getCurrentApplication().exit();
//    	} else if (templates/nc-search-cars.html == true){
...
//        var patt = new RegExp("#/event/home");
//        var res = patt.test(str);
//        if(res ){
//        	alert("Back exit");
//        	//alert("Press ok again to exit");
//            window.tizen.application.getCurrentApplication().exit();
//        }else {
//        	alert("Back press str"+ str);
...
angular .module('ionicApp', ['ionic', 'angular.css.injector', 'ionSlider','youtube-embed'])
    ...
    .config(function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('eventmenu.nc-search-cars-by-price-detail', {
                url: "/nc-search-cars-by-price-detail",
                views: {
                    'menuContent': {
                        templateUrl: "templates/nc-search-cars-by-price-detail.html",
                        controller: "nc_searchCarsByPriceDetailCtrl"
                    }
                }
            })
//            .state('eventmenu.nc-search-cars-by-filter-price.html', {
//                url: "/nc-search-cars-by-filter-price.html",
//                views: {
//                    'menuContent': {
//                        templateUrl: "templates/nc-search-cars-by-filter-price.html",
//                        controller: "nc_searchCarsByfilterPriceCtrl"
//                    }
//                }
//            })
...
//            objectValue.city = 'All India';
            ...
            objectValue.usedCarValuationGetDetail.yearList = ['1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016'];
            ...
            return {
                ...
                clenCarSelection: function(){
                	console.log("clenCarSelection");
                	objectValue.varientDetailObj.first.imageUrlList = "images/select_car_1.png";
                    objectValue.varientDetailObj.first.displayVariantId = "Select Car 1";
                    objectValue.varientDetailObj.first.OnRoadPrice = "";
                ...
                getUsedCarSearchResult: function (isTruested, cb) {
                    var serachString = "http://www.cardekho.com/getIPhoneFeedsDispatchAction.do?authenticateKey=14@89cardekho66feeds&parameter=getUsedCarSearchResultDataWithStatus&format=Gson&startLimit=1&endLimit=100";
                   ...
                   console.log("PriceRange"+JSON.stringify(objectValue));
                ...
                getDataFromApi: function (apiOption, paramValue, callBackFun) {
                    ...
                    switch (apiOption) {
                        ...
                        case 'reviewUserAndRoadTestDetailObj':
                            ...
                            break;
                        case 'priceDetails' :
                        	urlToSearch += "getNewCarSearchResultData&startLimit=1&endLimit=20&PriceRange="+paramValue;
                            break;
                    }

                    console.log("get data from api ::--->" + JSON.stringify(urlToSearch));
                ...
                setVarientID : function(varientObj){
                	//alert(JSON.stringify(varientObj));
    ...
    [
        ...
        function ($scope, sharedProperties, $stateParams, $state) {
            ...
            $scope.newPrice = function (priceSelected) {
                ...
                //var urlToCount = "getNewCarSearchResultData&PriceRange="+$scope.selectedPrice.join("+");
                sharedProperties.getHttpData(urlToCount, function(data){
                	console.log("Hari"+JSON.stringify(data));
//                	console.log("urlToCount"+JSON.stringify(urlToCount));
                    $scope.$emit('priceRangeCarCount', data);
                })
//               var urlToCount1 = "getNewCarSearchResultData&PriceRange="+$scope.selectedPrice.join("+");
//                sharedProperties.getHttpData(urlToCount, function(data){
//                	console.log("Hari"+JSON.stringify(urlToCount1));
//                	console.log("PriceRange"+JSON.stringify(urlToCount1));
//                    $scope.$emit('priceRangeCarCount', data);
//                })
    ...
    [
        ...
        function ($scope, sharedProperties, $state, $stateParams) {
            ...
            $scope.newBrand = function (brand) {
            	...
            	sharedProperties.setModel("Select Model");
            	  //alert(brand);  // secound time 
            	  console.log("hari",brand);
                console.log(brand);
...
//            sharedProperties.clenCarSelection();     
//            
...
//                $state.go('eventmenu.used-car-detail', {'isTrusted':'trusted'});
//
//                // console.log('In SearchCar'+
//                // $scope.isAdvanceSerach);
//            }
        ...
        function ($scope, sharedProperties, $rootScope, $state, cssInjector) {
            ...
            $scope.searchCar = function () {
             ...
             $scope.isAdvanceSerach == false;
                ...
                // JSON.stringify(sharedProperties.getObject()));
                //sharedProperties.getUsedCarSearchResult();
               // sharedProperties.setCertifiedByTrustMaster($scope.isCertified);
                if( $scope.isCertified == false)
                $state.go('eventmenu.used-car-detail', {'isTrusted':''});
                else{
                 $state.go('eventmenu.used-car-detail', {'isTrusted':'trusted'});
...
screen = "usedCarDetailCtl";
           ...
           // $scope.imgScr = "images/trust_mark_uncheck.png";
            ...
            //sharedProperties.setCertifiedByTrustMaster($scope.isCertified);
             ...
             if( $scope.sharedObj.certifiedByTrustMaster == false){
              $scope.imgScr  = "images/trust_mark_uncheck.png";
             }
             else{
              $scope.imgScr  = "images/trust_mark_check.png";
            ...
            $scope.cr_trustmark = function (){
             //alert("trust : "+trust);
             $scope.sharedObj.certifiedByTrustMaster=!$scope.sharedObj.certifiedByTrustMaster;
              //trust = !trust; 
             // alert("trust : "+trust);
              if( $scope.sharedObj.certifiedByTrustMaster == true){
...
screen = "usedsingleCarDetailCtl";
    ...
    [
        ...
        function ($scope, sharedProperties, $state, cssInjector, $ionicLoading) {
            ...
            var urlToCount = "getNewCarSearchResultData&PriceRange="+ $scope.selectedPrice;
            ...
            $scope.viewAllCars = function () {
            	console.log("urlToCount"+JSON.stringify(urlToCount));
            	if ($scope.selectedRangeCarsCount == null) {
	                ...
	                sharedProperties
	                    .getDataFromApi('priceDetails', $scope.brand.price, function (data) {
	                        $ionicLoading.hide();
	                        console.log('data for price detail '+ JSON.stringify(data));
	                        $state.go('eventmenu.nc-search-cars-by-price-detail');
        ...
        .controller(
      'nc_searchCarsByPriceDetailCtrl',
    [
        '$scope',
        'sharedProperties',
        '$state',
        ...
        function ($scope, sharedProperties, $state, cssInjector, $ionicLoading) {
            console.log("in nc_searchCars");
           // cssInjector.add("css/nc-search-cars.css");
            cssInjector.add("css/searchCarsByPriceDetail.css");
            
            $scope.detailPrice = sharedProperties
                .getObject();
            
            
            // Added By Hari starting 
            ...
            // Ending  get_latestCarDetail 
            
            console.log('$scope.detailPrice',$scope.detailPrice);
...
//          .controller(
//    'nc_searchCarsByfilterPriceCtrl',
//    [
//        '$scope',
//        'sharedProperties',
//        '$state',
...
screen = "nc_brandDetails";
            ...
            cssInjector.add("css/nc-brand-details.css");
...
screen = "nc_modelDetails";
           ...
           $scope.fn_vary = function (varientObj) {
        	   //alert("varientObj");
                //sharedProperties.setVarientID(ncBrandDetail);
        	   sharedProperties.setCurrentModelNumber('first');
        	   varientObj.imageUrlList =  $scope.imageUrl;
               sharedProperties.setVarientID(varientObj);
                   
                   $state.go('eventmenu.compare-cars');
                   //$state.go('eventmenu.varient-id',{"retunEvent":"compare-cars"});
              }
//            $scope.fn_vary = function(modelVarient){
//                console.log("fn_selectModel "+ modelVarient);
//                sharedProperties.setModel(modelVarient);
//                sharedProperties.setCurrentModelNumber('first');
//                $state.go('eventmenu.varient-id',{"retunEvent":"compare-cars"});
//            }
            ...
            $scope.fnGetOnRoadPrice = function() {
                ...
                sharedProperties.getCityAndPin(function(cityAndPingObjs){
                    ...
                    roadPriceForm = "/"+$scope.ncModelDetails.ncModelDetailsObj.data.Brand+"/"+	$scope.ncModelDetails.ncModelDetailsObj.data.modelname+"/"+$scope.imageUrl+"/"+$scope.ncModelDetails.ncModelDetailsObj.data.modelrating.rating;
            ...
            $scope.fn_ncRecCarDetail = function (recommendedCars) {
                ...
                sharedProperties
                    .getDataFromApi('ncModelDetailsObj', recommendedCars.carmodelname, function () {
                        ...
                        brandModel = recommendedCars.carmodelname;
                    })
...
screen = "nc_getOnRoadPriceFormCtrl";
            ...
            $scope.getUserCity = function(){
                setReqParam();
                var isValidationSuccess = true;                   // added by hari 
                $scope.sharedObj.pincode ="Select Pincode";         
...
screen = "nc_getOnRoadPriceDetailCtrl";
            $scope.loading = $ionicLoading.show({
                template: ''
            });
...
screen = "nc_latestCars";
            cssInjector.add("css/nc-latest-cars.css");
            sharedProperties.clenCarSelection();
            var searchString = "getLatestCarListDataWithStatus&startLimit=1&endLimit=50";
            sharedProperties.clenCarSelection();
...
screen = "nc_popularCars";
            var searchString = "getPopularCarListDataWithStatus&startLimit=1&endLimit=50";
            sharedProperties.clenCarSelection();
...
//               alert("$scope.offerAndDiscountObj.city"+$scope.offerAndDiscountObj.selectedBrand);
//               alert("$scope.offerAndDiscountObj.city"+$scope.offerAndDiscountObj.selectedModel);
                console.log("Brand:"+$scope.offerAndDiscountObj.selectedBrand+"Model:"+$scope.offerAndDiscountObj.selectedModel);
               if ($scope.offerAndDiscountObj.selectedBrand == 'Select Brand') {
                	isValidationSuccess = false;
                    alert("Please Select Brand");
                } 
//               else if ($scope.offerAndDiscountObj.selectedModel == 'Select Model') {
//                	isValidationSuccess = false;
...
screen = "compareCarsCtrl";
            ...
            if ($scope.compDataObj.varientDetailObj.second.displayVariantId != "Select Car 2" && $scope.compDataObj.varientDetailObj.first.displayVariantId != "Select Car 1"){
            	//alert("VariantID"+$scope.compDataObj.varientDetailObj.second.displayVariantId);
            	console.log("VariantID"+$scope.compDataObj.varientDetailObj.second.displayVariantId);
...
screen = "reviewUserAndRoadTestCtrl";            
            sharedProperties.clenCarSelection();
...
screen = "userReviewCtrl";            
            var baseUrl = "http://www.cardekho.com/getIPhoneFeedsDispatchAction.do?authenticateKey=14@89cardekho66feeds&format=Gson&parameter="
            $scope.modelDetailObject = sharedProperties.getObject();


            var urlToSearch = baseUrl + "getReviewsWithStatus&startLimit=1&endLimit=40&ModelName="+$scope.modelDetailObject.model+"&sortedBy=";
        ...
        function ($scope, sharedProperties, $window, $location,
            ...
            if (retunEvent == 'used-car-valuation-get-detail') {
               ...
               urlToSerach = "getCarVariantDetailByCarModelName&ModelName=" + selectedModel;
            	//urlToSerach = "getCarVariantDetailWithStatus&CarVariantId="+ selectedModel;
            }
            //alert(selectedModel.carVariantId);
